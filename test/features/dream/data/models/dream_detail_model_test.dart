...
void main() {
  final tDreamDetailModel = DreamDetailModel(
    ...
    mood: '평화로움',
    color: Color(int.parse('6fafcc', radix: 16)).withAlpha(255),
    content:
    ...
    createdAt: DateTime.parse("2024-03-15T00:00:00.000Z"),
    updatedAt: DateTime.parse("2024-03-15T00:00:00.000Z"),
  );
  ...
  group('fromJson', () {
    test('JSON 데이터로부터 DreamDetailModel 객체를 올바르게 생성해야 함', () {
      ...
      final Map<String, dynamic> jsonMap =
          json.decode(fixture('dream_detail_dream001.json'));
  ...
  group('toJson', () {
    test('DreamDetailModel 객체를 JSON 데이터로 올바르게 변환해야 함', () {
      ...
      // assert
      final expectedMap = json.decode(fixture('dream_detail_dream001.json'));
